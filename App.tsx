...
import { INITIAL_BOARD, PIECE_CHARS } from './server/common/constants';
import { BoardState, Color, Position, Move, GameStatus, AIModel, Piece } from './server/common/types';
import { getLegalMoves, applyMove, isCheck } from './server/chessRules';
import { getBestMoveMinimax } from './server/minimax';
